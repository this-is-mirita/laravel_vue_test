...
<template>
    <div class="login-page">
        <div class="register-form col-md-6 offset-md-3 mt-5">
            ...
            <div class="mb-3">
                <label for="emailInput" class="form-label">Имя</label>
                <div class="position-relative">
                    <input id="name" v-model="name" type="text" class="form-control custom-focus" placeholder="Введите имя"/>
                    <svg class="icon-svg position-absolute end-0 top-50 translate-middle-y me-3" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input id="emailInput" v-model="email" type="email" class="form-control custom-focus" placeholder="Введите email"/>
                    <svg class="icon-svg position-absolute end-0 top-50 translate-middle-y me-3" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M4.05894 18.6523L4.91627 14.7943L9.40834 19.2864L5.55033 20.1437C4.65721 20.3422 3.86047 19.5454 4.05894 18.6523ZM10.6427 18.3994L5.80324 13.56L15.2471 4.11612C15.7352 3.62796 16.5267 3.62796 17.0149 4.11612L18.5507 5.65196L20.0865 7.1878C20.5747 7.67595 20.5747 8.46741 20.0865 8.95556L10.6427 18.3994Z"
                            stroke="#A4AEB7" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <div class="mb-3">
                ...
                <div class="position-relative">
                    <input id="passwordInput" v-model="password" type="password" class="form-control custom-focus" placeholder="Введите пароль"/>
                    <svg class="icon-svg position-absolute end-0 top-50 translate-middle-y me-3" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M4.05894 18.6523L4.91627 14.7943L9.40834 19.2864L5.55033 20.1437C4.65721 20.3422 3.86047 19.5454 4.05894 18.6523ZM10.6427 18.3994L5.80324 13.56L15.2471 4.11612C15.7352 3.62796 16.5267 3.62796 17.0149 4.11612L18.5507 5.65196L20.0865 7.1878C20.5747 7.67595 20.5747 8.46741 20.0865 8.95556L10.6427 18.3994Z"
                            stroke="#A4AEB7" stroke-width="1.5" stroke-linecap="round"/>
